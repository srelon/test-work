<template>
    <div class="flex flex-col gap-1.5">
        ...
        <textarea
            ...
            :rows="rows"
            class="w-full resize-y rounded-md border bg-white px-3.5 py-2.5 text-sm text-neutral-900 outline-none transition-colors placeholder:text-neutral-400 focus:border-neutral-900"
        ...
        <input
            ...
            :name="name || undefined"
            :placeholder="placeholder"
            class="w-full rounded-md border bg-white px-3.5 py-2.5 text-sm text-neutral-900 outline-none transition-colors placeholder:text-neutral-400 focus:border-neutral-900"
            :class="display_error ? 'border-red-400' : 'border-neutral-300'"
            @input="on_input"
            @blur="on_blur"
        >
